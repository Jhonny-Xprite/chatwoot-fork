...
<template>
  <ButtonGroup
    class="flex flex-col justify-center items-center absolute top-4 ltr:right-3 rtl:left-3 bg-n-solid-2/95 backdrop-blur-lg border border-n-weak/50 rounded-2xl gap-1.5 p-1.5 shadow-md transition-shadow duration-200 hover:shadow-lg !z-30"
  >
    <Button
