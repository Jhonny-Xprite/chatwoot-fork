...
<template>
  <div
    class="flex flex-col flex-shrink-0 conversations-list-wrap bg-white/40 dark:bg-n-slate-1/40 backdrop-blur-md border-r border-n-slate-3/30 dark:border-n-slate-2/10 shadow-sm"
    :class="[
