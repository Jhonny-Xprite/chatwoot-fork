...
<template>
  <div
    class="fixed inset-0 z-[2100] flex items-center justify-center bg-black/50"
  >
        ...
        <div class="grid grid-cols-2 gap-6 mb-6">
          <div class="border-2 border-red-200 rounded-lg p-4 bg-red-50">
            <div class="flex items-center justify-between mb-4">
              ...
              <span
                class="inline-block px-2 py-1 bg-red-200 text-red-800 text-xs rounded font-medium"
              >
                Will be deleted
              </span>
            </div>
          ...
          <div class="border-2 border-green-200 rounded-lg p-4 bg-green-50">
            <div class="flex items-center justify-between mb-4">
              ...
              <span
                class="inline-block px-2 py-1 bg-green-200 text-green-800 text-xs rounded font-medium"
              >
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-medium text-blue-900">
                {{ source.message_count + target.message_count }} messages will
                be consolidated
              </p>
              <p class="text-sm text-blue-800 mt-1">
                All messages from "{{ source.name }}" will be moved to "{{
                  target.name
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-yellow-800 mt-1">
                The source contact will be marked as deleted but can be restored
