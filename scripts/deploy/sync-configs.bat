@echo off
set REMOTE_PATH=/etc/easypanel/projects/clientes-tools/a2/code/docker-compose.yml
set REMOTE_USER=root
set REMOTE_HOST=92.112.176.118
...
echo.
echo ✅ Configuracoes sincronizadas e deploy disparado!
pause
